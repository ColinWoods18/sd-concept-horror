...
urls = [
      "https://get.wallhere.com/photo/1600x1200-px-ART-artistic-artwork-creepy-dark-evil-fantasy-Halloween-horror-original-scary-spooky-1870009.jpg",
      "https://get.wallhere.com/photo/Scary-Stories-to-Tell-in-the-Dark-horror-book-cover-church-monochrome-grave-trees-clouds-building-2245736.jpg",
      "https://get.wallhere.com/photo/aliens-Xenomorph-creature-horror-science-fiction-creepy-2136821.jpg",
      "https://get.wallhere.com/photo/2880x1800-px-ART-artistic-artwork-creepy-dark-evil-fantasy-Halloween-horror-original-psychedelic-scary-spooky-1805049.jpg",
      "https://get.wallhere.com/photo/1920x1200-px-ART-artistic-artwork-creepy-dark-evil-fantasy-Halloween-horror-original-psychedelic-scary-spooky-1861455.jpg"
...
def download_image(url):
    try:
        ...
        print(f"Unable to download image from {url}. Error: {e}")
    except IOError as e:
        print(f"Unable to identify image file. Error: {e}")
    return None
...
image_grid(images, 1, len(images)).show()
...
initializer_token = "scary" #@param {type:"string"}
